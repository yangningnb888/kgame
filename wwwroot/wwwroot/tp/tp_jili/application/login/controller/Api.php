...
class Api extends Controller
{
    ...
    public function uptel ()
    {
        ...
        $tels = Db::table('jh_user_register')->field('*')->where(['telephone' => $post['new_telephone']])->find();
        if ($tels) {
        ...
        $user = Db::table('jh_user_register')->field('*')->where(['telephone' => $post['old_telephone']])->find();
        if ($user) {
            Db::table('jh_user_register')->where('uid', $user['uid'])->update(['telephone' => $post['new_telephone']]);
