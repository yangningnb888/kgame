...
trait Jump
{
     ...
     * @param mixed $code 返回代码
     */
    public function api_success($info, $data = '{-null-}', $code = 200)
    {
        if ($data === '{-null-}') $data = new stdClass();
        throw new HttpResponseException(json(['code' => $code, 'msg' => $info, 'obj' => $data]));
    }
     ...
     * @return array
     */
    protected function Page($page, $count, $pageSize = 10)
    {
        if ($page == 0) {
            $page = 1;
        }
     ...
     * @return string
     */
    protected function http_sign($data, $platform_key)
    {
        ksort($data);
        $str = '';
