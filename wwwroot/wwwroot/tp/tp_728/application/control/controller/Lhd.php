...
class Lhd extends Controller
{
    ...
    public function index()
    {
        ...
        $info = $player_bets->field('playerbets,endtime,last_type,last_win')->where('gtype', 6)->where('level', 5)->find();
        ...
        $res = Db::name('jh_game_config')->field('controls,profit')->where('level', 5)->where('gtype', 6)->find();
